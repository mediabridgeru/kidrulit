...
$_['entry_checkcert']      = 'Проверять сертификат сервера банка<br><small>При активации обязательно загрузите актуальный файл сертификата (подробнее в документации)</small>';
