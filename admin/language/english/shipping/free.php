<?php
// Heading
$_['heading_title']    = 'Для остальных регионов - Почтой России (стоимость доставки рассчитает оператор)';

// Text 
$_['text_shipping']    = 'Для остальных регионов - Почтой России (стоимость доставки рассчитает оператор)';
