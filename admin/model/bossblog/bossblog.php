...
class ModelBossblogBossblog extends Model {
    public function dropBlog(){
        $this->db->query("DROP TABLE `" . DB_PREFIX . "blog_article`, `" . DB_PREFIX . "blog_article_category`, `" . DB_PREFIX . "blog_article_description`, `" . DB_PREFIX . "blog_article_layout`, `" . DB_PREFIX . "blog_article_related`, `" . DB_PREFIX . "blog_article_store`, `" . DB_PREFIX . "blog_category`, `" . DB_PREFIX . "blog_category_description`, `" . DB_PREFIX . "blog_category_layout`, `" . DB_PREFIX . "blog_category_store`, `" . DB_PREFIX . "blog_comment`");
    }
