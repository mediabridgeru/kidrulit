...
class ModelPaymentYoomoney extends Model
{
    ...
    private $repository = 'cms/repos/cms-opencart15';
    ...
    public function getPaymentMethods()
    {
        if ($this->paymentMethods === null) {
            ...
            $this->paymentMethods = array(
                ...
                YooMoneyPaymentMethod::MODE_MONEY   => new YooMoneyPaymentMoney($this->config, $this->language),
            );
        }
    ...
    {
        $client = $this->getClient($this->getPaymentMethod(YooMoneyPaymentMethod::MODE_KASSA));
        try {
            $shopInfo = $client->me();
        } catch (\Exception $e) {
            $this->log('error', 'Error to shop info');
            return null;
        }
    ...
    /**
     * @param YooMoneyPaymentMethod $paymentMethod
     *
     * @return Client
     */
    public function getClient(YooMoneyPaymentMethod $paymentMethod)
    {
        if ($this->client === null) {
            $this->client = $paymentMethod->getYookassaClient($this);
        }
