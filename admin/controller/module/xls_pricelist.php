...
class ControllerModuleXlsPricelist extends Controller {
	...
	public function index() {   
		...
		$this->data['entry_use_code'] = $this->language->get('entry_use_code');
		$this->data['entry_use_special'] = $this->language->get('entry_use_special');
		...
		$this->data['entry_use_image'] = $this->language->get('entry_use_image');
		...
		if (isset($this->request->post['xls_pricelist_use_image'])) {
			$this->data['xls_pricelist_use_image'] = $this->request->post['xls_pricelist_use_image'];
		} else {
			$this->data['xls_pricelist_use_image'] = $this->config->get('xls_pricelist_use_image');
		}
		...
		if (isset($this->request->post['xls_pricelist_use_special'])) {
			$this->data['xls_pricelist_use_special'] = $this->request->post['xls_pricelist_use_special'];
		} else {
			$this->data['xls_pricelist_use_special'] = $this->config->get('xls_pricelist_use_special');
		}
		...
		if (isset($this->request->post['xls_pricelist_use_code'])) {
			$this->data['xls_pricelist_use_code'] = $this->request->post['xls_pricelist_use_code'];
		} else {
			$this->data['xls_pricelist_use_code'] = $this->config->get('xls_pricelist_use_code');
		}
