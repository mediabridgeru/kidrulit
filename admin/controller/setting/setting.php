...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
        ...
        $this->data['entry_glbuh'] = $this->language->get('entry_glbuh');
        ...
        if (isset($this->request->post['config_org'])) {
            $this->data['config_org'] = $this->request->post['config_org'];
        } else {
            $this->data['config_org'] = $this->config->get('config_org');
        }

        if (isset($this->request->post['config_rk_dov'])) {
            $this->data['config_rk_dov'] = $this->request->post['config_rk_dov'];
        } else {
            $this->data['config_rk_dov'] = $this->config->get('config_rk_dov');
        }

        if (isset($this->request->post['config_glbuh'])) {
            $this->data['config_glbuh'] = $this->request->post['config_glbuh'];
        } else {
            $this->data['config_glbuh'] = $this->config->get('config_glbuh');
        }

        if (isset($this->request->post['config_buh_dov'])) {
            $this->data['config_buh_dov'] = $this->request->post['config_buh_dov'];
        } else {
            $this->data['config_buh_dov'] = $this->config->get('config_buh_dov');
        }

        if (isset($this->request->post['config_kass'])) {
            $this->data['config_kass'] = $this->request->post['config_kass'];
        } else {
            $this->data['config_kass'] = $this->config->get('config_kass');
        }

        if (isset($this->request->post['config_manager'])) {
            $this->data['config_manager'] = $this->request->post['config_manager'];
        } else {
            $this->data['config_manager'] = $this->config->get('config_manager');
        }

        if (isset($this->request->post['config_inn'])) {
            $this->data['config_inn'] = $this->request->post['config_inn'];
        } else {
            $this->data['config_inn'] = $this->config->get('config_inn');
        }

        if (isset($this->request->post['config_requisites'])) {
            $this->data['config_requisites'] = $this->request->post['config_requisites'];
        } else {
            $this->data['config_requisites'] = $this->config->get('config_requisites');
        }
