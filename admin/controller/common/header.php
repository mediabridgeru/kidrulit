...
class ControllerCommonHeader extends Controller {
	protected function index() {
		...
		if (!$this->user->isLogged() || !isset($this->request->get['token']) || !isset($this->session->data['token']) || ($this->request->get['token'] != $this->session->data['token'])) {
			...
			$this->data['report_sale_order'] = $this->url->link('report/sale_order', 'token=' . $this->session->data['token'], 'SSL');/* IMReport Start */ $this->data['module_imreport'] = $this->url->link('module/IMReport', 'token=' . $this->session->data['token'], 'SSL'); /* IMReport End */
