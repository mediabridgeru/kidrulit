...
class ControllerBossblogCategory extends Controller { 
	...
	public function insert() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->redirect($this->url->link('bossblog/category', 'token=' . $this->session->data['token'], 'SSL')); 
		}
	...
	private function getList() {
		...
		$this->data['insert'] = $this->url->link('bossblog/category/insert', 'token=' . $this->session->data['token'], 'SSL');
		$this->data['delete'] = $this->url->link('bossblog/category/delete', 'token=' . $this->session->data['token'], 'SSL');
		...
		foreach ($results as $result) {
			...
			$action[] = array(
				...
				'href' => $this->url->link('bossblog/category/update', 'token=' . $this->session->data['token'] . '&blog_category_id=' . $result['blog_category_id'], 'SSL')
			);
		...
		$this->template = 'bossblog/category_list.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
	...
	private function getForm() {
       ...
       $this->document->addStyle('view/stylesheet/bossblog.css');
		...
		if (!isset($this->request->get['blog_category_id'])) {
			$this->data['action'] = $this->url->link('bossblog/category/insert', 'token=' . $this->session->data['token'], 'SSL');
		} else {
			$this->data['action'] = $this->url->link('bossblog/category/update', 'token=' . $this->session->data['token'] . '&blog_category_id=' . $this->request->get['blog_category_id'], 'SSL');
		}
		
		$this->data['cancel'] = $this->url->link('bossblog/category', 'token=' . $this->session->data['token'], 'SSL');
		...
		if (isset($this->request->post['blog_category_description'])) {
			...
			$this->data['blog_category_description'] = $this->model_bossblog_category->getCategoryDescriptions($this->request->get['blog_category_id']);
		} else {
		...
		if (isset($this->request->post['blog_category_store'])) {
			...
			$this->data['blog_category_store'] = $this->model_bossblog_category->getCategoryStores($this->request->get['blog_category_id']);
		} else {
		...
		if (isset($this->request->post['blog_category_layout'])) {
			...
			$this->data['blog_category_layout'] = $this->model_bossblog_category->getCategoryLayouts($this->request->get['blog_category_id']);
		} else {
		...
		$this->template = 'bossblog/category_form.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
