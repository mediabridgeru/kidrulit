    ...
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
      ...
      <div id="tab-customer-fields">
        ...
        <table class="form" style="margin-bottom:50px;">
          ...
          <tr class="row_values" <?php if ($field['type'] != 'select' && $field['type'] != 'radio' && $field['type'] == 'checkbox') { ?>style="display:none;"<?php } ?>>
            <td>
          ...
          <tr class="row_init">
            ...
            <td id="init">
                ...
                <?php } elseif ($field['type'] == 'textarea') { ?>                
                    <textarea name="simple_fields_main[<?php echo $field['id'] ?>][init]"><?php echo $field['init'] ?></textarea>
