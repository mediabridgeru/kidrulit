...
<!-- Option Sales -->
<!-- ------------ -->
<div class="tab-pane" id="option_sales">
	<form class="form" 
		action="<?php echo $report_links['option_sales']; ?>" method="post" 
		enctype="multipart/form-data" 
		id="form_option_sales"
	>
		...
		<div class="well">
			<div class="row">
				...
				<div class="col-sm-12 report-btn-group">
					...
					<span id="save_status_option_sales"></span>
				</div>
			</div>
		</div>
		<div class="table-responsive">
			<table class="table table-bordered table-results">
				<thead>
					<tr>
						<th><?php echo label($module_table_header, 'table_option_sales_name'); ?></th>
						<th><?php echo label($module_table_header, 'table_option_sales_count'); ?></th>
					</tr>	
				</thead>
				<tbody>
...
<style type="text/css">
	...
	#save_status_option_sales.success
	{
    	color: green;
	    top: 10px;
	    position: relative;
