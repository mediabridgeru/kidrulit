<div class="content">
 ...
 <form id="form-stores-list">
  ...
  <table class="list">
   ...
   <tfoot>
    <tr>
     <td class="center"><a class="button" onclick="editProductList('stores', 'upd');"><?php echo $button_save; ?></a> <a class="button" onclick="$('#dialog').dialog('close');">X</a></td>
    </tr>
   </tfoot>
  </table>
 </form>
