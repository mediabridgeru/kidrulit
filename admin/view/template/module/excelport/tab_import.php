<table class="form">
    ...
    <tr>
        <td>
            <input type="hidden" id="last_import_input" name="ExcelPort[LastImport]" value="<?php echo !empty($data['ExcelPort']['LastImport']) ? $data['ExcelPort']['LastImport'] : ''; ?>" />
            <div id="last_import" data-template="<?php echo $text_last_import; ?>" data-text="<?php echo !empty($data['ExcelPort']['LastImport']) ? $data['ExcelPort']['LastImport'] : ''; ?>">
            </div>
        	<div>
