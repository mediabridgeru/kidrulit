        ...
        <form action="" method="post" id="log-form">
            ...
            <div class="row buttons">
                <div class="col-12" style="text-align: right;">
                    <button type="button" class="btn btn-primary" data-value="download"><?= $lang->get('log_download')?></button>
                    <button type="button" class="btn btn-danger" data-value="clear-logs"><?= $lang->get('log_clear')?></button>
                </div>
            </div>
        </form>
        <div class="row">
