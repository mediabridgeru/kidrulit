    ...
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
      <table class="form">
        ...
        <tr>
          ...
          <td><?php if ($sbacquiring_servadr == 'real') { ?>
            <input type="radio" name="sbacquiring_servadr" value="self" />
            <?php echo $entry_servadr_self; ?>
            <input type="radio" name="sbacquiring_servadr" value="real" checked="checked" />
            <?php echo $entry_servadr_real; ?>
            <input type="radio" name="sbacquiring_servadr" value="0" />
            <?php echo $entry_servadr_test; ?>
            <?php } else if($sbacquiring_servadr == 'self'){ ?>
            <input type="radio" name="sbacquiring_servadr" value="self" checked="checked" />
            <?php echo $entry_servadr_self; ?>
            <input type="radio" name="sbacquiring_servadr" value="real" />
            <?php echo $entry_servadr_real; ?>
            <input type="radio" name="sbacquiring_servadr" value="0" />
            <?php echo $entry_servadr_test; ?>
            <?php } else { ?>
            ...
            <input type="radio" name="sbacquiring_servadr" value="real" />
            <?php echo $entry_servadr_real; ?>
            <input type="radio" name="sbacquiring_servadr" value="0" checked="checked" />
            <?php echo $entry_servadr_test; ?>
            <?php } ?></td>
        </tr>
        <tr>
          <td><?php echo $entry_self; ?></td>
          <td><input type="text" name="sbacquiring_servadr_self" value="<?php echo isset($sbacquiring_servadr_self) ? $sbacquiring_servadr_self : ''; ?>" ><br />
          <?php if ($error_self) { ?>
        ...
        <tr>
          ...
          <td><?php if ($sbacquiring_zapros) { ?>
            <input type="radio" name="sbacquiring_zapros" value="1" checked="checked" />
            <?php echo $entry_fgc; ?>
            <input type="radio" name="sbacquiring_zapros" value="0" />
            <?php echo $entry_curl; ?>
            <?php } else { ?>
            <input type="radio" name="sbacquiring_zapros" value="1" />
            <?php echo $entry_fgc; ?>
            <input type="radio" name="sbacquiring_zapros" value="0" checked="checked" />
            <?php echo $entry_curl; ?>
            <?php } ?></td>
        </tr>
        ...
        <tr>
          ...
          <td><?php if ($sbacquiring_bankcurrency) { ?>
            <input type="radio" name="sbacquiring_bankcurrency" value="1" checked="checked" />
            <?php echo $entry_currency_self; ?>
            <input type="radio" name="sbacquiring_bankcurrency" value="0" />
            <?php echo $entry_currency_rub; ?>
            <?php } else { ?>
            <input type="radio" name="sbacquiring_bankcurrency" value="1" />
            <?php echo $entry_currency_self; ?>
            <input type="radio" name="sbacquiring_bankcurrency" value="0" checked="checked" />
            <?php echo $entry_currency_rub; ?>
            <?php } ?></td>
        </tr>
        <tr>
          <td><?php echo $entry_currency_self_text; ?></td>
          <td><input type="text" name="sbacquiring_bankcurrency_self" value="<?php echo isset($sbacquiring_bankcurrency_self) ? $sbacquiring_bankcurrency_self : ''; ?>" ><br />
        ...
        <tr>
          ...
          <td><select name="sbacquiring_currency">
                    <?php foreach ($currencies as $currency) { ?>
                    <?php if ($currency['code'] == $sbacquiring_currency) { ?>
        ...
        <tr>
          ...
          <td><?php if ($sbacquiring_callbackemulate) { ?>
            <input type="radio" name="sbacquiring_callbackemulate" value="1" checked="checked" />
            <?php echo $entry_callbackemulate_no; ?>
            <input type="radio" name="sbacquiring_callbackemulate" value="0" />
            <?php echo $entry_callbackemulate_yes; ?>
            <?php } else { ?>
            <input type="radio" name="sbacquiring_callbackemulate" value="1" />
            <?php echo $entry_callbackemulate_no; ?>
            <input type="radio" name="sbacquiring_callbackemulate" value="0" checked="checked" />
            <?php echo $entry_callbackemulate_yes; ?>
            <?php } ?></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td><?php foreach ($languages as $language) { ?><img src="<?php echo $language['imgsrc']; ?>" title="<?php echo $language['name']; ?>" style="vertical-align:top;"/> <textarea name="sbacquiring_name_<?php echo $language['language_id']; ?>" cols="50" rows="1"><?php echo isset(${'sbacquiring_name_' . $language['language_id']}) ? ${'sbacquiring_name_' . $language['language_id']} : ''; ?></textarea><br />
            <?php } ?></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td><input type="text" name="sbacquiring_minpay" value="<?php echo isset($sbacquiring_minpay) ? $sbacquiring_minpay : ''; ?>" ></td>
        </tr>
        <tr>
          <td><?php echo $entry_maxpay; ?></td>
          <td><input type="text" name="sbacquiring_maxpay" value="<?php echo isset($sbacquiring_maxpay) ? $sbacquiring_maxpay : ''; ?>" ></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td><?php foreach ($languages as $language) { ?><img src="<?php echo $language['imgsrc']; ?>" title="<?php echo $language['name']; ?>" style="vertical-align:top;"/> <textarea name="sbacquiring_instruction_<?php echo $language['language_id']; ?>" cols="50" rows="3"><?php echo isset(${'sbacquiring_instruction_' . $language['language_id']}) ? ${'sbacquiring_instruction_' . $language['language_id']} : ''; ?></textarea><br /><?php } ?></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td><?php foreach ($languages as $language) { ?><img src="<?php echo $language['imgsrc']; ?>" title="<?php echo $language['name']; ?>" style="vertical-align:top;"/> <textarea name="sbacquiring_success_comment_<?php echo $language['language_id']; ?>" cols="50" rows="3"><?php echo isset(${'sbacquiring_success_comment_' . $language['language_id']}) ? ${'sbacquiring_success_comment_' . $language['language_id']} : ''; ?></textarea><br /><?php } ?></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td><?php foreach ($languages as $language) { ?><img src="<?php echo $language['imgsrc']; ?>" title="<?php echo $language['name']; ?>" style="vertical-align:top;"/> <textarea name="sbacquiring_hrefpage_text_<?php echo $language['language_id']; ?>" cols="50" rows="3"><?php echo isset(${'sbacquiring_hrefpage_text_' . $language['language_id']}) ? ${'sbacquiring_hrefpage_text_' . $language['language_id']} : ''; ?></textarea><br /><?php } ?></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td><?php foreach ($languages as $language) { ?><img src="<?php echo $language['imgsrc']; ?>" title="<?php echo $language['name']; ?>" style="vertical-align:top;"/> <textarea name="sbacquiring_success_page_text_<?php echo $language['language_id']; ?>" cols="50" rows="3"><?php echo isset(${'sbacquiring_success_page_text_' . $language['language_id']}) ? ${'sbacquiring_success_page_text_' . $language['language_id']} : ''; ?></textarea><br /><?php } ?></td>
        </tr>
         <?php /* ?><tr>
        ...
        <tr>
          ...
          <td><?php foreach ($languages as $language) { ?><img src="<?php echo $language['imgsrc']; ?>" title="<?php echo $language['name']; ?>" style="vertical-align:top;"/> <textarea name="sbacquiring_waiting_page_text_<?php echo $language['language_id']; ?>" cols="50" rows="3"><?php echo isset(${'sbacquiring_waiting_page_text_' . $language['language_id']}) ? ${'sbacquiring_waiting_page_text_' . $language['language_id']} : ''; ?></textarea><br /><?php } ?></td>
        </tr>
        <?php */ ?>
        <tr>
        ...
        <tr>
          ...
          <img src="<?php echo $language['imgsrc']; ?>" title="<?php echo $language['name']; ?>" style="vertical-align:top;"/> <textarea name="sbacquiring_fail_page_text_<?php echo $language['language_id']; ?>" cols="50" rows="3"><?php echo isset(${'sbacquiring_fail_page_text_' . $language['language_id']}) ? ${'sbacquiring_fail_page_text_' . $language['language_id']} : ''; ?></textarea><br /><?php } ?></td>
        </tr>
