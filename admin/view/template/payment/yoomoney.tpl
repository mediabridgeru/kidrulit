<?php echo $header; ?>
    ...
    <div id="content" class="container">
        <div class="row">
            <h3 class="form-heading qa-title"><?php echo $lang->get('module_settings_header'); ?></h3>
            <div class='col-md-12'>
                <p class="qa-info-label"><?php echo $lang->get('module_license'); ?></p>
                <p class="qa-module-version"><?php echo $lang->get('module_version'); ?> <span id='yoomoney_version'><?php echo $yoomoney_version; ?></span></p>
            </div>
        </div>
        ...
        <form action="<?php echo $action; ?>" method="post" id="form">
            ...
            <ul class="nav nav-tabs qa-layout-tabs" role="tablist">
                ...
                <div class="buttons text-right">
                    <a onclick="$('#form').submit();" class="button qa-save-button"><?php echo $lang->get('button_save'); ?></a>
                    <a href="<?php echo $cancel; ?>" class="button qa-cancel-button"><?php echo $lang->get('button_cancel'); ?></a>
                </div>
            </ul>
