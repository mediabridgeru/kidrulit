			...
			<table class="form">
				...
				<td><div class="scrollbox" style="height: 400px; overflow-x: auto; width: 100%;">
					...
					<div class="<?php echo $class; ?>">
						...
						<tr>
						<td>Категория Яндекс: <input type="text" name="yandex_yml_categ_mapping[<?php echo $category['category_id']; ?>]" value="<?php echo (isset($yandex_yml_categ_mapping[$category['category_id']]) ? $yandex_yml_categ_mapping[$category['category_id']] : ''); ?>" class="yandex-categ" /></td>
						<td>local_delivery_cost: <input type="text" name="yandex_yml_categ_delivery_cost[<?php echo $category['category_id']; ?>]" value="<?php echo (isset($yandex_yml_categ_delivery_cost[$category['category_id']]) ? $yandex_yml_categ_delivery_cost[$category['category_id']] : ''); ?>" size="4" /></td>
						<td>sales_notes: <input type="text" name="yandex_yml_categ_sales_notes[<?php echo $category['category_id']; ?>]" value="<?php echo (isset($yandex_yml_categ_sales_notes[$category['category_id']]) ? $yandex_yml_categ_sales_notes[$category['category_id']] : ''); ?>"  size="30" /></td>
						</tr>
						</table>
