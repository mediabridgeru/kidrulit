...
<div id="content">
  ...
  <h1><?php echo $text_boss_catalog; ?></h1>
        <div class="htabs">
             <a class="selected" href="<?php echo $boss_category; ?>" style="display: inline;"><?php echo $text_boss_category ; ?></a>
          ...
          <div id="language<?php echo $language['language_id']; ?>">
            <table class="form">
              <tr>
                ...
                <td><input type="text" name="blog_category_description[<?php echo $language['language_id']; ?>][name]" size="100" value="<?php echo isset($blog_category_description[$language['language_id']]) ? $blog_category_description[$language['language_id']]['name'] : ''; ?>" />
              ...
              <tr>
                ...
                <td><textarea name="blog_category_description[<?php echo $language['language_id']; ?>][meta_description]" cols="40" rows="5"><?php echo isset($blog_category_description[$language['language_id']]) ? $blog_category_description[$language['language_id']]['meta_description'] : ''; ?></textarea></td>
              </tr>
              <tr>
                <td><?php echo $entry_meta_keyword; ?></td>
                <td><textarea name="blog_category_description[<?php echo $language['language_id']; ?>][meta_keyword]" cols="40" rows="5"><?php echo isset($blog_category_description[$language['language_id']]) ? $blog_category_description[$language['language_id']]['meta_keyword'] : ''; ?></textarea></td>
              </tr>
              <tr>
                <td><?php echo $entry_description; ?></td>
                <td><textarea name="blog_category_description[<?php echo $language['language_id']; ?>][description]" id="description<?php echo $language['language_id']; ?>"><?php echo isset($blog_category_description[$language['language_id']]) ? $blog_category_description[$language['language_id']]['description'] : ''; ?></textarea></td>
              </tr>
            </table>
          </div>
          <?php } ?>
          ...
          <table class="list">
            ...
            <tbody>
              <tr>
                ...
                <td class="left"><select name="blog_category_layout[0][layout_id]">
                    <option value=""></option>
            ...
            <tbody>
              <tr>
                ...
                <td class="left"><select name="blog_category_layout[<?php echo $store['store_id']; ?>][layout_id]">
                    <option value=""></option>
                    <?php foreach ($layouts as $layout) { ?>
