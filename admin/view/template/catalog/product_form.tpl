          ...
          <div id="language<?php echo $language['language_id']; ?>">
            <table class="form">
              <tr>
                ...
                <tr>
                    <td>Название товара для отчетов</td>
                    <td><input type="text" name="product_description[<?php echo $language['language_id']; ?>][report_name]" size="100" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['report_name'] : ''; ?>" /></td>
                </tr>
			  <tr>
        ...
        <div id="tab-data">
          <table class="form">
            ...
            <tr>
              ...
              <tr>
                  <td>Имеются товары этой модели с другим ГТД</td>
                  <td>
                      <input type="checkbox" name="upc_more" value="1" <?php echo (isset($upc_more) && $upc_more)?'checked':''; ?> />
                  </td>
              </tr>
            <tr>
            ...
            <tr>
              ...
              <td><input type="text" name="upc_quantity" value="<?php echo $upc_quantity; ?>" size="2" /></td>
            </tr>
              <tr>
                  <td>Количество в группе</td>
            ...
            <table id="option-value<?php echo $option_row; ?>" class="list">
              <thead>
                <tr>
                  ...
                  <td class="left">ГТД</td>
                    <td class="right"><?php echo $entry_quantity; ?></td>
                    <td class="right">Количество в группе</td>
              ...
              <tbody id="option-value-row<?php echo $option_value_row; ?>">
                <tr>
                  <td class="left"><select name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][option_value_id]">
                    ...
                    <td class="right"><input type="text" name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][ob_upc]" value="<?php echo $product_option_value['ob_upc']; ?>" size="15" /></td>
                    <td class="right"><input type="text" name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][ob_quantity]" value="<?php echo $product_option_value['ob_quantity']; ?>" size="3" /></td>
...
function addOptionValue(option_row) {	
	...
	html += '    <td class="right"><input type="text" name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][ob_upc]" value="" size="3" /></td>';
    html += '    <td class="right"><input type="text" name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][ob_quantity]" value="" size="3" /></td>';
