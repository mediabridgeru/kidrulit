        ...
        <div id="tab-general">
          <table class="form">
            ...
            <tr>
              ...
              <tr><td><?php echo $entry_org; ?></td><td><input type="text" name="config_org" value="<?php echo $config_org; ?>" size="60" /></td></tr>
              <tr><td><?php echo $entry_rk_dov; ?></td><td><input type="text" name="config_rk_dov" value="<?php echo $config_rk_dov; ?>" size="60" /></td></tr>
              <tr><td><?php echo $entry_glbuh; ?></td><td><input type="text" name="config_glbuh" value="<?php echo $config_glbuh; ?>" size="60" /></td></tr>
              <tr><td><?php echo $entry_buh_dov; ?></td><td><input type="text" name="config_buh_dov" value="<?php echo $config_buh_dov; ?>" size="60" /></td></tr>
              <tr><td><?php echo $entry_kass; ?></td><td><input type="text" name="config_kass" value="<?php echo $config_kass; ?>" size="60" /></td></tr>
              <tr><td><?php echo $entry_manager; ?></td><td><input type="text" name="config_manager" value="<?php echo $config_manager; ?>" size="60" /></td></tr>
              <tr><td><?php echo $entry_inn; ?></td><td><input type="text" name="config_inn" value="<?php echo $config_inn; ?>" size="60" /></td></tr>
              <tr>
                  <td><?php echo $entry_requisites; ?></td>
                  <td><textarea name="config_requisites" cols="100" rows="2"><?php echo $config_requisites; ?></textarea>
              </tr>
			<tr>
              <td><?php echo $entry_welcome; ?></td>
              <td><textarea name="config_welcome" cols="100" rows="2"><?php echo $config_welcome; ?></textarea>
            </tr>
            <tr>
              <td><span class="required">*</span> <?php echo $entry_address; ?></td>
              <td><textarea name="config_address" cols="100" rows="2"><?php echo $config_address; ?></textarea>
			...
			<tr>
			  ...
			  <td><textarea name="config_maps" cols="100" rows="2"><?php echo $config_maps; ?></textarea>
            </tr>
            <tr>
