          ...
          <thead>
            <tr>
              ...
              <td class="left"><?php if ($sort == 'status') { ?>
                ...
                <?php } ?></td>
                <td class="right">Доставка СДЭК</td>
