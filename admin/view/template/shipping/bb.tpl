...
<div id="content">
    ...
    <div class="box">
        <div class="heading">
            <h1><img src="view/image/bb_shipping.gif" alt="" /> <?php echo $heading_title; ?></h1>
            <div class="buttons"><a onclick="$('#form').submit();" class="button"><?php echo $button_save; ?></a><a href="<?php echo $cancel; ?>" class="button"><?php echo $button_cancel; ?></a></div>
        </div>
        <div class="content">
            <div class="vtabs"><a href="#tab-general"><?php echo $tab_general; ?></a>
                <?php foreach ($geo_zones as $geo_zone) { ?>
                <a href="#tab-geo-zone<?php echo $geo_zone['geo_zone_id']; ?>"><?php echo $geo_zone['name']. ' ('; echo (${'bb_' . $geo_zone['geo_zone_id'] . '_status'}) ? $text_enabled . ')' : $text_disabled. ')'; ?></a>
                <?php } ?>
            </div>
            <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
                <div id="tab-general" class="vtabs-content">
                    <table class="form">
                        ...
                        <tr>
            <td>API Url</td>
            <td><input type="text" style="width: 250px;" name="bb_api_url" value="<?php echo $bb_api_url; ?>" /></td>
        </tr>
        <tr>
                            <td><?php echo $entry_api_token; ?></td>
            <td><input type="text" style="width: 250px;" name="bb_api_token" value="<?php echo $bb_api_token; ?>" /></td>
        </tr>
        <tr>
            <td><?php echo $entry_yandex_map_key; ?></td>
            <td><input type="text" style="width: 250px;" name="bb_yandex_map_key" value="<?php echo $bb_yandex_map_key; ?>" /></td>
                        </tr>
                        <tr>
        ...
        <tr style="background: lightcyan">
            ...
            <td>
                ...
                <label><input type="radio" name="bb_foreign_insurance" value="0" <?php echo !$bb_foreign_insurance ? 'checked="checked"' : '' ?>><?php echo $text_no; ?></label>
                        ...
                        <tr><td/><td><a id="btn-copy" onclick="copy_settings(); return false" class="button"><?php echo $button_copy_settings; ?></a></td></tr>
                    </table>
                </div>
                <?php foreach ($geo_zones as $geo_zone) { ?>
...
<script type="text/javascript"><!--
    ...
    function gen_license_id() {
        $.ajax({
            ...
            cache:  false ,
            dataType: 'json',
            url:  'index.php?route=shipping/bb/license&token=<?php echo $token; ?>',
