...
function copy_data() {
    $('#copy_data').html('<a class="top" ><img src="view/image/loading.gif" /></a>');
    $.ajax({
        url: '<?php echo HTTP_CATALOG; ?>index.php?route=account/copy_data',
        type: 'post',
        data: 'action=copy_data',
        dataType: 'json',
        success: function (json) {
            ...
            if (json['error']) {
                if (json['error']['warning']) {
                    $('#copy_data').html('<a class="top" style="color:red;" >' + json['error']['warning'] + '</a>');
            ...
            if (json['success']) {
                $('#copy_data').html('<a class="top" style="color:#03e603;">Скопировано ' + json['success'] + '</a>');
  ...
  <div id="menu">
    <ul class="left" style="display: none;">
      ...
      <li id="sale"><a class="top"><?php echo $text_sale; ?></a>
        <ul>
          ...
          <li><a href="<?php echo $contact; ?>"><?php echo $text_contact; ?></a></li>
            <li><a href="<?php echo $sbacquiring; ?>"><?php echo $text_sbacquiring; ?></a></li>
        </ul>
      </li>
        ...
        <ul>
          <li><a class="parent"><?php echo $text_sale; ?></a>
            <ul>
              ...
              <!-- IMReport Start --><li id="module_imreport"><a href="<?php echo $module_imreport; ?>">IMReport (1.5)</a></li><!-- IMReport End --><li><a href="<?php echo $report_sale_coupon; ?>"><?php echo $text_report_sale_coupon; ?></a></li>
            </ul>
          </li>
      ...
      <li id="help"><a class="top"><?php echo $text_help; ?></a>
        ...
        <li id="copy_data"><a class="top" href="#" onclick="copy_data(); return false;" style="color:yellow;">Скопировать данные ИП в юрлиц</a></li>
    </ul>
