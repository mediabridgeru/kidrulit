	...
	public function index() {
		...
		foreach ($results as $key => $value) {
			...
			if ($this->customer->isLogged()) {
				...
				$this->load->model('account/address');
				$this->session->data['payment_address_id'] = $this->customer->getAddressId();//tan
...
*/
			...
			//echo $data['payment_code'].'-';
			/*
			if ($this->cart->hasShipping()) {
				if ($this->customer->isLogged()) {
					$this->load->model('account/address');
					$this->session->data['shipping_address_id'] = $this->customer->getAddressId();//tan
