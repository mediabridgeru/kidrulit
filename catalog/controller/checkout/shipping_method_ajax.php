<?php 
class ControllerCheckoutShippingMethodAjax extends Controller {
	public function index() {
		...
		if (isset($this->request->post['shipping_code'])) {
			$this->data['code'] = $this->request->post['shipping_code'];//$this->session->data['shipping_method']['code'];
		} else {
			$this->data['code'] = '';
		}
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/checkout/shipping_method_ajax.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/checkout/shipping_method_ajax.tpl';
		} else {
			$this->template = 'default/template/checkout/shipping_method_ajax.tpl';
		}
