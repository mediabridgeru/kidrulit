...
class ControllerAccountReturn extends Controller { 
	...
	public function insert() {
        ...
        if (isset($this->request->post['acceptance'])) {			$this->data['acceptance'] = $this->request->post['acceptance'];		}        $this->data['oferta'] = $this->url->link('information/information', 'information_id=3');
