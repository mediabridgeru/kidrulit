...
/*
	...
	*/	
		if (isset($this->request->post['acceptance'])) {
			$this->data['acceptance'] = $this->request->post['acceptance'];		
		}
        $this->data['oferta'] = $this->url->link('information/information', 'information_id=3');
	...
	protected function validate() {
		...
		if(!$res['success']) {
			...
			$this->error['captcha'] = 'Вы не прошли проверку reCaptcha';
		} 
