...
//
        ...
        foreach($order['total'] as $total) {
            if($total['code']=='total') {
                ...
                $worksheet->SetCellValue('K47', $this->mb_ucfirst($this->num2str2($total['value'])));
        ...
        foreach($order['product'] as $product) {
            ...
            $worksheet->SetCellValue('E'.$numcell, htmlspecialchars_decode($product['report_name']));
...
//$worksheet->SetCellValue('AH'.$numcell, 'шт.');
