...
class ControllerCommonHeader extends Controller {
	protected function index() {
        ...
        $this->document->addStyle('catalog/view/javascript/jquery/owl_carousel/owl.carousel.css');
        $this->document->addStyle('catalog/view/javascript/jquery/owl_carousel/owl.theme.css');
