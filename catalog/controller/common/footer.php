...
class ControllerCommonFooter extends Controller {
	protected function index() {
        ...
        $this->document->addScript('catalog/view/javascript/bossthemes/jquery.easing.js', 'footer');
        $this->document->addScript('catalog/view/javascript/jquery/owl_carousel/owl.carousel.min.js', 'footer');
        $this->document->addScript('catalog/view/javascript/bossthemes/fancybox/jquery.fancybox.js', 'footer');
        $this->document->addScript('catalog/view/javascript/bossthemes/cloud-zoom/cloud-zoom.1.0.3.js', 'footer');
        $this->document->addScript('catalog/view/javascript/options_boost.js', 'footer');
