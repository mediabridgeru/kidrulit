...
<div class="boss_special" > <?php if ($products) { ?>
 ...
 <div class="row">
  ...
  <?php $item = 4; $col = 24/$item;?>
    <?php foreach ($products as $key => $product) { ?><div class="col-sm-4 col-xs-24 col-md-<?php echo $col; ?>"><div class="not-animated" data-animate="fadeInUp" data-delay="<?php echo $key*50+100; ?>">
      <?php if ($product['thumb']) { ?>
      <div class="image"><div class="boss_image"><a href="<?php echo $product['href']; ?>"><b></b><img class="image-fly" src="<?php echo $product['thumb']; ?>" title="<?php echo $product['name']; ?>" alt="<?php echo $product['name']; ?>" /></a>
