...
<div class="shoppingcart_fr">
  <h1 class="h1margin"><?php echo $heading_title; ?>
    <?php if ($weight) { ?>
    &nbsp;(<?php echo $weight; ?>)
    <?php } ?>
  </h1>
...
<?php } ?>
  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
    <div class="table-responsive cart-info table table-bordered">
      <table>
        <thead>
          <tr>
        ...
        <tbody>
          <?php foreach ($products as $key => $product) { ?>
           <?php if($product['recurring']): ?>
              <tr>
                  <td colspan="7" style="border-top:1px solid #cccccc;border-bottom:1px solid #cccccc;padding-top:15px;padding-bottom:15px;padding-left:17px;border-left:none;"><image src="catalog/view/theme/default/image/reorder.png" alt="" title="" style="float:left; " /><span style="line-height:18px; margin-left:10px; overflow:hidden"> 
	    ...
	    <tr class="<?php if($key==0){ echo 'first';} ?><?php if($product==end($products) && !$vouchers){echo ' last';} ?>" >
			...
			<td class="quantity"><input type="text" name="quantity[<?php echo $product['key']; ?>]" value="<?php echo $product['quantity']; ?>" size="1" /><input type="image" src="catalog/view/theme/<?php echo $this->config->get('config_template'); ?>/image/update.png" alt="<?php echo $button_update; ?>" title="<?php echo $button_update; ?>" /><a href="<?php echo $product['remove']; ?>"><img src="catalog/view/theme/<?php echo $this->config->get('config_template'); ?>/image/removex.png" alt="<?php echo $button_remove; ?>" title="<?php echo $button_remove; ?>" /></a></td>			
          ...
          <tr class="<?php if($key==0 && !$products){ echo 'first';} ?><?php if($key==($count_voucher-1)){echo ' last';} ?>">
			...
			<td class="name vouchers"><span><?php echo $vouchers['description']; ?></span></td>
			 <td class="model"></td>						 			 
			  <td class="unitprice vouchers"><span class="price"><?php echo $vouchers['amount']; ?></span></td>
			   <td class="quantity vouchers"><input type="text" name="" value="1" size="1" disabled="disabled" /><a href="<?php echo $vouchers['remove']; ?>"><img src="catalog/view/theme/<?php echo $this->config->get('config_template'); ?>/image/removex.png" alt="<?php echo $button_remove; ?>" title="<?php echo $button_remove; ?>" /></a></td>
  ...
  <div class="cart-module">
    ...
    <div id="shipping" class="content" style="display: <?php echo ($next == 'shipping' ? 'block' : 'none'); ?>;">
      ...
      <table>
        <tr>
          <td class="module_cart_sh"><span class="tt_input"><?php echo $entry_country; ?></span> <span class="required">*</span> </td>
		  </tr>
        <tr>
        ...
        <tr>
          <td class="module_cart_sh"><span class="tt_input"><?php echo $entry_zone; ?></span> <span class="required">*</span> </td>
		  </tr>
        <tr>
        ...
        <tr>
          <td class="module_cart_sh"><span class="tt_input"><?php echo $entry_postcode; ?></span> <span id="postcode-required" class="required">*</span> </td>
		  </tr>
        <tr>
 ...
 <div class="cart-total">
	...
	<a href="<?php echo $checkout; ?>" class="btn btn-color btn-checkout"><?php echo $button_checkout; ?></a>
