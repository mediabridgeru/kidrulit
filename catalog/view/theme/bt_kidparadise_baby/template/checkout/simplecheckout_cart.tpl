    ...
    <?php foreach ($products as $product) { ?>
        <tr>
            ...
            <td class="name" >
                ...
                <?php } ?>
                <a <?php if (!$product['stock']) { ?> class="product_unavailable" <?php } ?> href="<?php echo $product['href']; ?>"><?php echo $product['name']; ?></a>
...
<?php if (isset($modules['coupon'])) { ?>
    <div class="simplecheckout-cart-total">
        <span class="inputs coupons"><?php echo $entry_coupon; ?>&nbsp;<input type="text" name="coupon" value="<?php echo $coupon; ?>" onchange="simplecheckout_reload('coupon_changed')"  /></span>
    </div>
<?php } ?>
