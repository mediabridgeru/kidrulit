...
<div style="width: 680px;"><a href="<?php echo $store_url; ?>" title="<?php echo $store_name; ?>"><img src="<?php echo $logo; ?>" alt="<?php echo $store_name; ?>" style="margin-bottom: 20px; border: none;" /></a>
  ...
  <table style="border-collapse: collapse; width: 100%; border-top: 1px solid #DDDDDD; border-left: 1px solid #DDDDDD; margin-bottom: 20px;">
    ...
    <?php if (!empty($docs)) : ?>
    <div class="docs">
        <h2>Вы выбрали предоплату в качестве способа расчета:</h2>
        <ul>
        ...
        <ul>
            <li><a target="_blank" href="<?php echo $torg12; ?>"><i class="fa fa-download"></i>Скачать накладную ТОРГ-12 в формате Excel</a></li>
        ...
        <p>Заказ будет отправлен только после внесения полной предоплаты.</p>
  ...
  <?php /* <p style="margin-top: 0px; margin-bottom: 20px;"><?php echo $text_powered; ?></p> */ ?>
</div>
</body>
</html>
