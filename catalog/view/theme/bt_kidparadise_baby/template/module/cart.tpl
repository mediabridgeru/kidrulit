...
<div id="boss_cart">
  <div class="heading" >
    <h4><a href="<?php echo $cart; ?>" class="check_shop"><?php echo $heading_title; ?><br /><span id="quantity_product"><?php echo $quantity_products; ?></span></a></h4>	
  </div>
  <div class="content">
