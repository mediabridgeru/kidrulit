<?php foreach ($products as $key => $product) { ?><div class="col-xs-24 col-sm-8 col-md-6 col-lg-6" data-animate="fadeInUp" data-delay="<?php echo $key*50 + 100; ?>" data-prodid="<?php echo $product['product_id']; ?>">
...
<?php echo (!empty($product['sticker'])) ? $product['sticker'] : ''; ?></div>
<?php } ?>
