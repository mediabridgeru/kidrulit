...
?>
    ...
    <div class="footer-info">
        <?php if ($informations) { ?>
        <div class="column col-xs-24 col-sm-12 col-md-6 col-lg-6 not-animated" data-delay="200">
        ...
        <div class="column col-xs-24 col-sm-12 col-md-6 col-lg-6 not-animated" data-delay="300">
        ...
        <div class="column col-xs-24 col-sm-12 col-md-6 col-lg-6 not-animated" data-delay="500">
