...
<div class="<?php if($option['fullwidth'] == "on") echo "fullwidthbanner-container"; else echo "bannercontainer";?> ">
	...
	<div class="col-sm-24 col-xs-24 col-md-24">
		<div class="<?php if($option['fullwidth'] == "on") echo "fullwidthbanner"; else echo "banner";?>">
			<ul>
				<?php foreach($slides as $slide) { if($slide['status']){ ?>
					...
					<?php if ($slide['type_background'] == "color_bg") { ?>
						<img alt="" src="image/data/transparent.png" style="background-color:<?php echo $slide['background'];?>" >
					<?php }else{ ?>
						<img alt="" src="<?php echo $slide['background'];?>" >
					<?php } ?>
...
<?php 
if (file_exists('catalog/view/theme/' . $this->config->get('config_template') . '/stylesheet/bossthemes/boss_revolutionslider/css/settings.css')) {
			echo '<link rel="stylesheet" type="text/css" href="catalog/view/theme/' . $this->config->get('config_template') . '/stylesheet/bossthemes/boss_revolutionslider/css/settings.css" media="screen" />';
		} else {
			echo '<link rel="stylesheet" type="text/css" href="catalog/view/theme/default/stylesheet/bossthemes/boss_revolutionslider/css/settings.css" media="screen" />';
		}
?>
</div>
</section>
