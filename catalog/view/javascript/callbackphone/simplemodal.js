...
(function(d) {
	...
	d.modal2 = function(a, b) {
		return d.modal2.impl.init(a, b)
	};
	d.modal2.close = function() {
		d.modal2.impl.close()
	};
	d.modal2.focus = function(a) {
		d.modal2.impl.focus(a)
	};
	d.modal2.setContainerDimensions = function() {
		d.modal2.impl.setContainerDimensions()
	};
	d.modal2.setPosition = function() {
		d.modal2.impl.setPosition()
	};
	d.modal2.update = function(a, b) {
		d.modal2.impl.update(a, b)
	};
	d.fn.modal2 = function(a) {
		return d.modal2.impl.init(this, a)
	};
	d.modal2.defaults = {
		appendTo : "body",
		focus : true,
	...
	d.modal2.impl = {
		...
		init : function(a, b) {
			...
			c.o = d.extend({}, d.modal2.defaults, b);
			c.zIndex = c.o.zIndex;
			c.occb = false;
			if ( typeof a === "object") {
		...
		create : function(a) {
			...
			f = b.getDimensions();
			if (b.o.modal2 && k)
				b.d.iframe = d('<iframe src="javascript:false;"></iframe>').css(d.extend(b.o.iframeCss, {
					display : "none",
					opacity : 0,
					position : "fixed",
					height : f[0],
			...
			b.d.overlay = d("<div></div>").attr("id", b.o.overlayId).addClass("simplemodal-overlay").css(d.extend(b.o.overlayCss, {
				...
				height : b.o.modal2 ? f[0] : 0,
				width : b.o.modal2 ? f[1] : 0,
				position : "fixed",
				left : 0,
				top : 0,
				zIndex : b.o.zIndex + 1
		...
		bindEvents : function() {
			...
			a.o.modal2 && a.o.close && a.o.overlayClose && a.d.overlay.bind("click.simplemodal", function(b) {
				b.preventDefault();
				a.close()
			});
			d(document).bind("keydown.simplemodal", function(b) {
				if (a.o.modal2 && b.keyCode === 9)
					a.watchTab(b);
		...
		fixIE : function() {
			...
			d.each([a.d.iframe || null, !a.o.modal2 ? null : a.d.overlay, a.d.container], function(c, h) {
				if (h) {
					var g = h[0].style;
					g.position = "absolute";
					if (c < 2) {
