...
class ModelSaleOrder extends Model
{
    ...
    public function getOrderOptionByProductOptionValueId($order_id, $product_option_value_id) {
        $query = $this->db->query("SELECT * FROM " . DB_PREFIX . "order_option WHERE order_id = '" . (int)$order_id . "' AND product_option_value_id = '" . (int)$product_option_value_id . "'");
