...
class ModelPaymentYoomoney extends Model
{
        ...
        try {
            ...
            $confirmation = array(
                ...
                'returnUrl' => str_replace(
                    array('&amp;'),
                    array('&'),
                    $this->url->link('payment/yoomoney/confirm', 'order_id='.$orderInfo['order_id'], 'SSL')
                ),
            );
    ...
    {
        if ($this->config->get('yoomoney_kassa_debug_mode') || $this->config->get('yoomoney_wallet_debug_mode')) {
